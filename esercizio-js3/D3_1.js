...
switch (currentCharacter.eye_color) {
   case 'blue': eyeColor.blue.push(currentCharacter);
   break;
   case 'yellow': eyeColor.yellow.push(currentCharacter);
   break;
   case 'brown': eyeColor.brown.push(currentCharacter);
   break;
   case 'red': eyeColor.red.push(currentCharacter);
   break;
   case 'blue-gray': eyeColor['blue-gray'].push(currentCharacter);
   break;
   default: console.log("Nessuna corrispondenza");
}
}
...
while (i < starWarsCharacters.length){
  const currentCharacter = parseInt(starWarsCharacters[i].mass);
  crewMass = (crewMass + currentCharacter);
  i++;
}
...
switch(true){
      ...
      break;
      default:console.log("Impossibile calcolare peso");
} 
